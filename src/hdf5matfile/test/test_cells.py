...
def test_1d_arrays():
    ...
    a1 = c2.flat[0]
    a2 = c2.flat[1]
    assert_array_equal(a1, np.array([[1.0, 2.0, 3.0, 4.0]]))
    assert_array_equal(a2, np.array([[5.0, 6.0, 7.0, 8.0]]))
...
def test_2d():
    ...
    a21 = c3[1, 0]
    a22 = c3[1, 1]
    assert_array_equal(a11, np.array([[1.0, 2.0, 3.0, 4.0]]))
    assert_array_equal(a12, np.array([[5.0, 6.0, 7.0, 8.0]]))
    assert_array_equal(a21, np.array([[4.0, 3.0, 2.0, 1.0]]))
    assert_array_equal(a22, np.array([[8.0, 7.0, 6.0, 5.0]]))
